...
- 需求文档 `语音编程工具-需求分析与方案说明.md`（v0.3，2026-08-17；§8 开放问题第 1–4 项已决策，命名维持暂名）是需求与方案的唯一事实来源。
...
**VoicePrompt（暂名）**——一款 macOS 菜单栏常驻的语音驱动 AI 编程工具。
...
5. 命名：维持暂名 VoicePrompt（唯一未决项，不阻塞任何工作）。
